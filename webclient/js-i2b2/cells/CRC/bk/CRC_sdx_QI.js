			...
			switch (o.result_type) {
				...
				*/
				default:
					...
					/*
					try {
						var t = o.result_type = i2b2.h.XPath(ps[i1],'query_result_type/description/text()')[0].nodeValue;

						// i2b2.h.XPath(ps[i1],'self::description')[0].firstChild.nodeValue;
					} catch(e) { var t = "unknown"; }
					// create the title using shrine setting
